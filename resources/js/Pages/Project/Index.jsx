                                ...
                                <table className="min-w-full border-collapse">
                                    <thead className="bg-gray-100">
                                        <tr className="text-left text-sm font-semibold text-gray-700">
                                            ...
                                            <th className="border p-2 cursor-pointer" onClick={() => sortChanged('name')}>
                                            ...
                                            <th className="border p-2 cursor-pointer" onClick={() => sortChanged('created_at')}>
                                                <div className="flex items-center gap-1">
                                            ...
                                            <th className="border p-2 cursor-pointer" onClick={() => sortChanged('due_date')}>
                                                <div className="flex items-center gap-1">
                                                    <span>Due Date</span>
                                            ...
                                            <th className="border p-2 cursor-pointer" onClick={() => sortChanged('status')}>
                                                <div className="flex items-center gap-1">
                                                    <span>Status</span>
